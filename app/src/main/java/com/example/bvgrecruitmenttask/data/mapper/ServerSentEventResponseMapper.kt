...
class ServerSentEventResponseMapper @Inject constructor(moshi: Moshi,) {

    private val serverSentEventResponseAdapter: JsonAdapter<ServerSentEventResponse> = moshi.adapter(ServerSentEventResponse::class.java)

    fun mapEventResponse(json: String, type: String?): Event? {
        return try {
