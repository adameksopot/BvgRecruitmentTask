...
@HiltViewModel
class ServerSentEventsViewModel @Inject constructor(private val serverSentEventsRepository: ServerSentEventsRepository) : ViewModel() {
